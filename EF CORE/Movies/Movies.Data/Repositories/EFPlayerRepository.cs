...
namespace Movies.Data.Repositories
{
    public class EFPlayerRepository : IPlayerRepository
    {
        ...
        {
            var existing=await moviesDbContext.Players.AsNoTracking().FirstOrDefaultAsync(p=>p.Id==id);
        ...
        {
            return await moviesDbContext.Players.AsNoTracking().FirstOrDefaultAsync(p=>p.Id==id);
        }
